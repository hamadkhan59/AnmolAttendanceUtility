    ...
    public partial class Master : Form
    {
        ...
        private void btnPullData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lstMachineInfo = manipulator.GetCheckOutdata(objZkeeper, int.Parse(tbxMachineNumber.Text.Trim()));
                }
                else
                {
                    lstMachineInfo = manipulator.GetCheckInLogData(objZkeeper, int.Parse(tbxMachineNumber.Text.Trim()));
                }
        ...
        private void btnUploadUserInfo_Click(object sender, EventArgs e)
        {
            ...
            //info.EnrollNumber = "59";
            //info.FingerIndex = 0;
            //info.Name = "Asif";
            //info.TmpData = "3541312";
            //lstUserInfo.Add(info);
            //bool flag = manipulator.UploadFTPTemplate(objZkeeper, int.Parse(tbxMachineNumber.Text.Trim()), lstUserInfo);
            //if (flag)
            //{
            //    MessageBox.Show("User is added succesfully");
            //}
            //else {
